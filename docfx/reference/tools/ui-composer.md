...
- Native WPF layout and media come from the explicit `core@0.1.0` pack with `role="layout-pack"`. Use qualified kinds such as `core.stack`, `core.grid`, `core.rowDefinition`, `core.columnDefinition`, `core.gridCell`, `core.border`, `core.image`, `core.text`, and `core.template`.
