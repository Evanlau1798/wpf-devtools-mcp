...
/// </summary>
public class GetLayoutInfoTool
{
    private readonly SessionManager _sessionManager;

    public GetLayoutInfoTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Layout information retrieval not yet implemented (requires Named Pipe communication)",
