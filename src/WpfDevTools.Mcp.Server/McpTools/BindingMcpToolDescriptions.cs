...
internal static class BindingMcpToolDescriptions
{
    ...
    public const string GetBindingMismatches =
        ...
        BindingMetadata + "Cross-reference target DependencyProperty types with resolved binding source property types and report deterministic path, type, and nullability mismatches.\n\n" +
    ...
    public const string GetBindings =
        ...
        BindingMetadata + "Get all DataBindings on an element. Shows binding path, mode " +
    ...
    public const string GetAffectedElements =
        ...
        BindingMetadata + "Scan a runtime element or subtree and return candidate elements whose binding declaration deterministically matches the supplied property name.\n\n" +
    ...
    public const string GetBindingErrors =
        ...
        BindingMetadata + "Get ALL binding errors captured since Inspector connected. " +
    ...
    public const string GetDataContextChain =
        ...
        BindingMetadata + "Get the DataContext inheritance chain from an element up to the root. " +
    ...
    public const string ForceBindingUpdate =
        ...
        BindingMetadata + "Force a binding to re-evaluate and transfer the current value. " +
