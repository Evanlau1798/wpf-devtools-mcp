...
public sealed class ResponseContractSchemaMetadataTests
{
    ...
    public void ResponseContractResource_ShouldExposeNumericParameterConstraints()
    {
        ...
        AssertNumericConstraint(constraints, "apply_ui_blueprint", "targetWindowWidth", null, 1, UiPreviewProjectFiles.MaximumViewportDimension);
        AssertNumericConstraint(constraints, "apply_ui_blueprint", "targetWindowHeight", null, 1, UiPreviewProjectFiles.MaximumViewportDimension);
