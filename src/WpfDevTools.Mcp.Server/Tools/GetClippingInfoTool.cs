...
/// </summary>
public class GetClippingInfoTool
{
    private readonly SessionManager _sessionManager;

    public GetClippingInfoTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Clipping information retrieval not yet implemented (requires Named Pipe communication)",
