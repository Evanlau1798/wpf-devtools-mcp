    ...
    public void ResponseContractResource_ShouldDistinguishEnvelopeFieldsAndListHighValueToolContracts()
    {
        ...
        AssertHighValueToolContract(
            ...
            nestedResponsePaths: [
                ...
                "resourceRead.sameSessionRequired", "resourceRead.chunking.uriTemplate", "resourceRead.chunking.maxChunkBytes", "resourceRead.chunking.fallbackOnly", "resourceRead.chunking.assembly"
            ]);
