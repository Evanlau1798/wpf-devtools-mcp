...
public static class InspectorConfig
{
    ...
    /// </summary>
    public static TimeSpan UIThreadTimeout { get; set; } = GetTimeoutFromEnv(
    ...
    /// </summary>
    public static TimeSpan PipeConnectTimeout { get; set; } = GetTimeoutFromEnv(
    ...
    /// </summary>
    public static TimeSpan RequestTimeout { get; set; } = GetTimeoutFromEnv(
    ...
    /// </summary>
    public static TimeSpan ShutdownTimeout { get; set; } = GetTimeoutFromEnv(
    ...
    /// </summary>
    public static TimeSpan HeartbeatInterval { get; set; } = GetTimeoutFromEnv(
