...
public sealed class McpToolOutputSchemaTests
{
    ...
    public void ExactHighValueTools_ShouldCoverKnownRuntimePayloadFields()
    {
        ...
        AssertNestedFields("element_screenshot", ["resourceRead", "chunking"], "uriTemplate", "maxChunkBytes", "fallbackOnly", "assembly");
    ...
    private static readonly HashSet<string> CommonSchemaFields = new(StringComparer.Ordinal)
    {
        ...
        "pendingEventsAreAdvisory",
        "pendingEventsSummary",
        "pendingEventsPiggybackFailed", "pendingEventsPiggybackFailureType", "pendingEventsMayRemainBuffered",
        "pendingEventsPiggybackRequiresReconnect", "pendingEventsStateAfterTimeoutUnknown", "pendingEventsPiggybackSuggestedAction",
        "restoreRequired", "restoreStatus", "restoreSuggestedAction",
        "cleanupIncomplete",
