...
/// </summary>
public class MeasureElementRenderTimeTool
{
    private readonly SessionManager _sessionManager;

    public MeasureElementRenderTimeTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Element render time measurement not yet implemented (requires Named Pipe communication)",
