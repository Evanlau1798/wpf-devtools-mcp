...
/// </summary>
public class ClearDpValueTool
{
    private readonly SessionManager _sessionManager;

    public ClearDpValueTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "DependencyProperty value clearing not yet implemented (requires Named Pipe communication)",
