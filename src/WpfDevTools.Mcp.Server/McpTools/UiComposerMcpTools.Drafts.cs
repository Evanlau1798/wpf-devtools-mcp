...
public static partial class UiComposerMcpTools
{
    ...
    public static Task<CallToolResult> CreateUiBlueprintDraft(
        ...
        [Description("wpfdevtools.ui-blueprint.v1:name,packs,primaryPack,layout,resourceVariants{packId:variantId};elementName->@Name; start with the smallest valid root or shell")] string blueprintJson,
    ...
    public static Task<CallToolResult> PatchUiBlueprintDraft(
        ...
        [StringLength(BoundaryStringLimits.MaxStringArgumentLength)]
        [Description("Set/remove target: $.layout.properties[\"accent.color\"], @Panel (whole node), or @Panel.properties.text. No patchJson.")] string? jsonPath = null,
