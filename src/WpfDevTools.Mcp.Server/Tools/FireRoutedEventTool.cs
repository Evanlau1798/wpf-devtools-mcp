...
/// </summary>
public class FireRoutedEventTool
{
    private readonly SessionManager _sessionManager;

    public FireRoutedEventTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Routed event firing not yet implemented (requires Named Pipe communication)",
