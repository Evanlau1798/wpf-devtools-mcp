...
/// </summary>
public class GetValidationErrorsTool
{
    private readonly SessionManager _sessionManager;

    public GetValidationErrorsTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Validation errors retrieval not yet implemented (requires Named Pipe communication)",
