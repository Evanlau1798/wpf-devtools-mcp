...
internal static class SceneDiagnosticsMcpToolDescriptions
{
    ...
    public const string GetStateDiff =
        ...
        SceneMetadata +
        "Compute semantic before/after differences for tracked DependencyProperty values, ViewModel properties, focus, binding errors, and validation errors.\n\n" +
    ...
    public const string GetElementSnapshot =
        ...
        SceneMetadata +
        "Gather element identity, selected DependencyProperty values, bindings, validation errors, style summary, layout summary, and DataContext type in one call.\n\n" +
    ...
    public const string DiagnoseVisibility =
        ...
        SceneMetadata +
        "Diagnose visibility blockers such as element or ancestor Visibility, zero Opacity, zero layout size, and explicit or WPF-generated layout clipping.\n\n" +
    ...
    public const string GetInteractionReadiness =
        ...
        SceneMetadata +
        "Aggregate enabled state, visibility, opacity, hit testing, layout size, and ButtonBase ICommand.CanExecute into one interaction readiness verdict.\n\n" +
    ...
    public const string GetUiSummary =
        ...
        SceneMetadata +
        "Traverse a WPF runtime subtree, suppress layout-only wrappers, and return a compact semantic overview of user-facing controls.\n\n" +
    ...
    public const string GetFormSummary =
        ...
        SceneMetadata +
        "Aggregate common input controls, nearby labels, current values, validation errors, command readiness, and overall form submittability.\n\n" +
