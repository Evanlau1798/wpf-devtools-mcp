...
/// </summary>
public class GetDataContextChainTool
{
    private readonly SessionManager _sessionManager;

    public GetDataContextChainTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "DataContext chain retrieval not yet implemented (requires Named Pipe communication)",
