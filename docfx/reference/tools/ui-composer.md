...
- `core.image` renders a project-owned WPF Resource through an application-local pack URI or a simple binding. It requires an accessible automation name and rejects external, file-system, UNC, and traversal URIs.
