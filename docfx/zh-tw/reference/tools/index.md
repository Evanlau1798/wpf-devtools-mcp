...
| 探索 Composer blocks | `list_ui_block_packs` | `get_ui_block_catalog` | 先列出 installed UI packs，再取得 block properties、slots、allowedKinds、renderer availability 與 provenance。 |
...
| UI Composer | `list_ui_block_packs`、`get_ui_block_catalog` | 在 blueprint 工作前探索 UI block packs 與 composition rules |
