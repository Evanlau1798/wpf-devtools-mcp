...
| 組合、render、preview、repair 並 apply Composer UI | `list_ui_block_packs` | `get_ui_block_catalog`、`compose_ui_blueprint`、`expand_ui_recipe`、`validate_ui_blueprint`、`render_ui_blueprint`、`preview_ui_blueprint`、`repair_ui_blueprint`、`apply_ui_blueprint` | 先列出 installed UI packs、逐步組合 pack-defined blocks 或展開 starter recipe，再驗證、render、preview、repair 並產生 guarded apply plan。 |
...
| UI Composer | `list_ui_block_packs`、`get_ui_block_catalog`、`compose_ui_blueprint`、`expand_ui_recipe`、`validate_ui_blueprint`、`render_ui_blueprint`、`preview_ui_blueprint`、`repair_ui_blueprint`、`apply_ui_blueprint` | 探索 UI block packs、逐步組合 pack-defined blocks，再展開、驗證、render、preview、repair 與 guarded-apply blueprints |
...
- `wpf://contracts/tools` SHA-256: `0be59f7ead380ecc0c4f8a89f3575d55fad3c04be7425a9edc0337814fa6a31e`
