...
- 使用 MCP resource `wpf://contracts/tools` 取得 canonical tool names、categories、safety flags、capability tags、parameter metadata 與 reflection-backed parameter `constraints`。
- 若 client bridge 截斷 contract resource，先讀 compact `wpf://contracts/index`。當 client 缺少 base64、UTF-8 byte decoding 或 hashing helpers 時，優先依序讀取它公告的 `wpf://contracts/{contractId}/text-chunks/{offset}/{length}` envelopes 並串接各段 `text`；需要精確 byte 與 SHA-256 驗證時，仍可使用 16 KiB binary chunk route。
...
- `wpf://contracts/tools` SHA-256: `5b6f91abbc51e4e207fbf1fc3d24ae3d022ff515e6e21b18d96a8b42092a165a`
- `wpf://contracts/response` SHA-256: `d64f50d0b69977f8a3467b2f39d7bb253efba11478f3e25ea21b5fbd3602fb5a`
