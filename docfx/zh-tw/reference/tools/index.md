...
- 如果需要 canonical tool metadata，請讀取 MCP resource `wpf://contracts/tools`。它會提供 tool name、category、safety flag 與 discovery alias 的 machine-readable JSON manifest。
