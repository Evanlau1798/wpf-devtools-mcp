...
public class GetTemplateTreeToolTests
{
    ...
    {
        // Arrange
        var tool = new GetTemplateTreeTool();
    ...
    [Fact]
    public async Task Execute_WithValidParameters_ShouldIncludeElementIdAndDepth()
    {
        // Arrange
        var sessionManager = new SessionManager();
        sessionManager.AddSession(12345);
        var tool = new GetTemplateTreeTool(sessionManager);
        var parameters = new { processId = 12345, elementId = "myControl", maxDepth = 3 };
