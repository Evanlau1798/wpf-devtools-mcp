...
static void RegisterProcessTools(ToolRegistry registry, SessionManager sessionManager)
{
...
static void RegisterDependencyPropertyTools(ToolRegistry registry, SessionManager sessionManager)
{
...
static void RegisterStyleTools(ToolRegistry registry, SessionManager sessionManager)
{
...
static void RegisterEventTools(ToolRegistry registry, SessionManager sessionManager)
{
...
static void RegisterInteractionTools(ToolRegistry registry, SessionManager sessionManager)
{
    ...
    RegisterTool(registry, "drag_and_drop",
        ...
        new { type = "object", properties = new { processId = new { type = "integer", description = "Target WPF process ID" }, sourceElementId = new { type = "string", description = "Source element ID" }, targetElementId = new { type = "string", description = "Target element ID" } }, required = new[] { "processId", "sourceElementId", "targetElementId" } },
...
// === 8. Layout (4 tools) ===
static void RegisterLayoutTools(ToolRegistry registry, SessionManager sessionManager)
{
    ...
    RegisterTool(registry, "highlight_element",
        ...
        new { type = "object", properties = new { processId = new { type = "integer", description = "Target WPF process ID" }, elementId = new { type = "string" }, color = new { type = "string", description = "Highlight color (optional)" }, duration = new { type = "integer", description = "Duration in milliseconds (optional)" } }, required = new[] { "processId" } },
...
// === 9. MVVM (5 tools) ===
static void RegisterMvvmTools(ToolRegistry registry, SessionManager sessionManager)
{
    ...
    RegisterTool(registry, "modify_viewmodel",
        ...
        new { type = "object", properties = new { processId = new { type = "integer", description = "Target WPF process ID" }, elementId = new { type = "string" }, propertyName = new { type = "string", description = "Property name to modify" }, value = new { type = "string", description = "New value to set" } }, required = new[] { "processId", "propertyName", "value" } },
...
static void RegisterPerformanceTools(ToolRegistry registry, SessionManager sessionManager)
{
