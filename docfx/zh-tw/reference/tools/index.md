...
| UI Composer | `list_ui_block_packs`、`get_ui_block_catalog`、`expand_ui_recipe`、`validate_ui_blueprint`、`render_ui_blueprint`、`preview_ui_blueprint`、`apply_ui_blueprint` | 探索 UI block packs、檢查 recipes 與 composition rules，並展開、驗證、render、compile-smoke 或 host-smoke，以及 guarded-apply blueprints |
