...
internal static class McpToolCapabilityCatalog
{
        ...
        string category)
    {
        ...
        if (attribute.Name is not "get_processes" and not "list_ui_block_packs" and not "get_ui_block_catalog" and not "validate_ui_blueprint" and not "expand_ui_recipe" and not "render_ui_blueprint" and not "apply_ui_blueprint")
        {
