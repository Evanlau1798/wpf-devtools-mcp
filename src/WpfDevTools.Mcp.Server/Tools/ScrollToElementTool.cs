...
/// </summary>
public class ScrollToElementTool
{
    private readonly SessionManager _sessionManager;

    public ScrollToElementTool(SessionManager? sessionManager = null)
    {
    ...
    public async Task<object> ExecuteAsync(object parameters, CancellationToken cancellationToken)
    {
        ...
        {
            success = true,
            message = "Scroll to element not yet implemented (requires Named Pipe communication)",
