...
internal static class DependencyPropertyMcpToolDescriptions
{
    ...
    public const string GetDpValueSource =
        ...
        DependencyPropertyMetadata + "Get the value source of a DependencyProperty. " +
    ...
    public const string GetDpMetadata =
        ...
        DependencyPropertyMetadata + "Get DependencyProperty metadata including default value, " +
    ...
    public const string SetDpValue =
        ...
        DependencyPropertyMetadata + "Set a DependencyProperty value at runtime. " +
    ...
    public const string ClearDpValue =
        ...
        DependencyPropertyMetadata + "Clear a DependencyProperty local value, " +
    ...
    public const string WatchDpChanges =
        ...
        DependencyPropertyMetadata + "Register a listener for property value changes. " +
    ...
    public const string WaitForDpChange =
        ...
        DependencyPropertyMetadata + "Wait for a DependencyProperty change using polling. " +
    ...
    public const string WaitForDpChangeAfterMutation =
        ...
        DependencyPropertyMetadata + "Execute one serialized mutation step, then wait for the resulting DependencyProperty transition using polling. " +
