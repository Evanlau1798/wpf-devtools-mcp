...
public sealed class ComposerPipelineContractTests
{
    ...
    public void EnglishUiComposerDocs_ShouldCoverStablePublicContracts()
    {
        ...
        documentation.Should().ContainAll(
            ...
            "local non-network storage",
            "reparse-point ancestor",
            "UNC, device, and other remote roots are rejected",
            "reject external or rooted image, navigation, media, XML, and resource-dictionary locations",
            "pack-declared application-local ResourceDictionary",
            "generic WPF framework safety rules",
            "no pack- or library-specific branching",
    ...
    public void TraditionalChineseUiComposerDocs_ShouldCoverStablePublicContracts()
    {
        ...
        documentation.Should().ContainAll(
            ...
            "pack 宣告的 application-local ResourceDictionary",
            "通用 WPF framework safety rules",
            "沒有 pack 或 library-specific branching",
            "可執行的第三方相依套件",
