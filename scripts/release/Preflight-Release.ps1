...
$publishScript = Resolve-ScriptPath -DefaultRelativePath 'scripts\release\Publish-Release.ps1' -OverridePath $env:WPFDEVTOOLS_PREFLIGHT_PUBLISH_SCRIPT
$exportScript = Resolve-ScriptPath -DefaultRelativePath 'scripts\release\Export-GitHubReleaseAssets.ps1' -OverridePath $env:WPFDEVTOOLS_PREFLIGHT_EXPORT_SCRIPT
