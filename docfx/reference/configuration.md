...
| `WPFDEVTOOLS_MCP_ALLOWED_TARGETS` | Restricts all MCP `connect()` targets | Required semicolon-separated exact local absolute executable paths; unset or malformed configured entries fail closed |
