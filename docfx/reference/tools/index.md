...
- Need canonical tool metadata? Read MCP resource `wpf://contracts/tools`. It publishes the machine-readable JSON manifest for tool names, categories, safety flags, and discovery aliases.
