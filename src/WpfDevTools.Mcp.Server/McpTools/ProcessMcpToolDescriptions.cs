...
internal static class ProcessMcpToolDescriptions
{
    ...
    public const string GetProcesses =
        ...
        ProcessMetadata + "List allowlisted WPF processes available for inspection and surface the metadata needed for explicit target selection.\n\n" +
        ...
        "WINDOW FILTERS: Use windowFilter='visible' (default), 'all' for hidden/background windows, or 'foreground' for the active WPF window.\n" +
    ...
    public const string SelectActiveProcess =
        ...
        "Set the active connected process for processId-omission workflows.\n\n" +
    ...
    public const string GetActiveProcess =
        ...
        ProcessMetadata + "Returns the active selected process, if any.\n\n" +
    ...
    public const string Connect =
        ...
        ProcessMetadata + "Connect to a WPF application by injecting the Inspector DLL. " +
    ...
    public const string Ping =
        ...
        ProcessMetadata + ToolDescriptionFragments.ConnectPrerequisite +
        "Check connection health and measure round-trip latency to the Inspector DLL " +
