...
public class HandlerParameterValidationTests
{
    ...
    // ---- Params with valid required fields succeed ----

    [Fact]
    public async Task BindingHandlers_GetBindingValueChain_WithPropertyName_ShouldReturnResult()
    {
        var handler = new BindingHandlers(new BindingAnalyzer(new ElementFinder()), new ElementFinder());
        var @params = JsonSerializer.SerializeToElement(new { propertyName = "Text" });
    ...
    [Fact]
    public async Task BindingHandlers_ForceBindingUpdate_WithPropertyName_ShouldReturnResult()
    {
        var handler = new BindingHandlers(new BindingAnalyzer(new ElementFinder()), new ElementFinder());
        var @params = JsonSerializer.SerializeToElement(new { propertyName = "Text" });
    ...
    [Fact]
    public async Task EventHandlers_TraceRoutedEvents_WithEventName_ShouldReturnResult()
    {
        var handler = new EventHandlers(new EventAnalyzer(new ElementFinder()));
        var @params = JsonSerializer.SerializeToElement(new { eventName = "Click" });
    ...
    [Fact]
    public async Task EventHandlers_GetEventHandlers_WithEventName_ShouldReturnResult()
    {
        var handler = new EventHandlers(new EventAnalyzer(new ElementFinder()));
        var @params = JsonSerializer.SerializeToElement(new { eventName = "Click" });
    ...
    [Fact]
    public async Task EventHandlers_FireRoutedEvent_WithEventName_ShouldReturnResult()
    {
        var handler = new EventHandlers(new EventAnalyzer(new ElementFinder()));
        var @params = JsonSerializer.SerializeToElement(new { eventName = "Click" });
    ...
    [Fact]
    public async Task InteractionHandlers_SimulateKeyboard_WithKey_ShouldReturnResult()
    {
        var handler = new InteractionHandlers(new InteractionAnalyzer(new ElementFinder()));
        var @params = JsonSerializer.SerializeToElement(new { key = "Enter" });
    ...
    [Fact]
    public async Task StyleHandlers_GetResourceChain_WithResourceKey_ShouldReturnResult()
    {
        var handler = new StyleHandlers(new StyleAnalyzer(new ElementFinder()));
        var @params = JsonSerializer.SerializeToElement(new { resourceKey = "PrimaryBrush" });
